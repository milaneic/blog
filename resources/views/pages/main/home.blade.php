                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset('assets/img/trending/'.$post->img) }}" alt="{{ $post->img }}">
                                            </div>
                                            <div class="trend-bottom-cap">
                                                <span class="color1">{{ $post->caption }}</span>
                                                <h4><a href="{{ route('post.show',$post)}}">{{ $post->description }}</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img src="{{ asset('assets/img/trending/'.$category->image) }}" alt="">
                                </div>
