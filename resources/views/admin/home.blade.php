                        ...
                        <ul class="item-list striped">
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin/brad_frost/128.jpg') }}"></div>
                                        </a>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin//_everaldo/128.jpg') }})"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin/eduardo_olv/128.jpg') }}"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin/why_this/128.jpg') }}"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin/w7download/128.jpg') }}"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    <div class="item-col fixed item-col-img xs">
                                        <a href="#">
                                            <div class="item-img xs rounded" style="background-image: {{ asset('assets/admin/pankogut/128.jpg') }}"></div>
                                        </a>
                                    </div>
                                    <div class="item-col item-col-title no-overflow">
                                        <div>
