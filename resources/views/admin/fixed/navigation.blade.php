                            ...
                            <ul class="notifications-container">
                                <li>
                                    <a href="#" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: {{ asset('admin/assets/faces/3.jpg') }}"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="#" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: {{ asset('admin/assets/faces/5.jpg') }}"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="#" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: {{ asset('admin/assets/faces/8.jpg') }}"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
